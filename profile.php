...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_profile'])) {
    ...
    if (empty($username) || empty($email)) {
        setFlashMessage("Username and email are required.", "danger");
    } else {
        ...
        if ($check_result->num_rows > 0) {
            ...
            // Update user profile
            $update_sql = "UPDATE users SET username = ?, email = ?, fullname = ?, gender = ?, profession = ?, bio = ? WHERE id = ?";
            $update_stmt = $conn->prepare($update_sql);
            $update_stmt->bind_param("ssssssi", $username, $email, $fullname, $gender, $profession, $bio, $user_id);
    ...
    <div class="col-md-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <p><strong><i class="fas fa-envelope me-2"></i>Email:</strong> <?php echo htmlspecialchars($user_data['email']); ?></p>
