        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <a href="transactions.php?action=add" class="btn btn-sm btn-primary">
                        <i class="fas fa-plus me-1"></i> Add Transaction
                    </a>
                    <a href="transactions.php?action=add_category" class="btn btn-sm btn-success ms-2">
                        <i class="fas fa-folder-plus me-1"></i> Add Category
                    </a>
                    <a href="transactions.php?action=manage_categories" class="btn btn-sm btn-info ms-2">
